<%@ Page Title="" Language="C#" MasterPageFile="~/SMSMainMaster.Master" AutoEventWireup="true" CodeBehind="StudentFees.aspx.cs" Inherits="SMS.StudentFees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="frm1" runat="server">
        <ul>
            <li>
                <asp:Label ID="lblHeading" runat="server" Text="Subject"
            ...
            <li>
                <div id="divView" runat="server" style="width: 100%; overflow: auto;">
                    <asp:DataGrid ID="dgCase" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="Student Fees ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridStudentFeesID" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Class ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridClassID" runat="server" Text='<%# Bind("ClassID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Class">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblGridClass" runat="server" CausesValidation="false" Width="100px"
                                        CommandName="cmd_edit" Text='<%# Bind("Class") %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Fees">
                                ...
                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="100px" Wrap="true" />
                                <ItemTemplate>
                                    <asp:Label ID="lblGridFees" runat="server" Width="200px" Text='<%# Bind("Fees") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                ...
                <asp:Panel ID="pnlDataDetail" runat="server">
                    <div id="divAddEdit" runat="server" style="width: 100%; text-align: left;">
                        <table style="width: 100%; text-align: left;">
                            <tr>
                                <th>
                                    <asp:Label ID="lblClass" runat="server" Text="Class Name :" CssClass="captionStyleBold"></asp:Label>
                                </th>
                                <th>
...
                                </th> 
                            ...
                            <tr>
                                <th>
                                    <asp:Label ID="lblName" runat="server" Text="Fees :" CssClass="CommonCaption"></asp:Label>
                                </th>
                                <th>
            ...
            <li>
                <div>
                    <asp:Button ID="btnAddStudentFees" runat="server" Text="Add Subject" Visible="true"
                        CausesValidation="true" OnClick="btnAddStudentFees_Click" />
