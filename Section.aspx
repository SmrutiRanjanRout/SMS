<%@ Page Title="" Language="C#" MasterPageFile="~/SMSMainMaster.Master" AutoEventWireup="true" CodeBehind="Section.aspx.cs" Inherits="SMS.Section" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="frm1" runat="server">
        <ul>
            <li>
                <asp:Label ID="lblHeading" runat="server" Text="Section"
            ...
            <li>
                <div id="divView" runat="server" style="width: 100%; overflow: auto;">
                    <asp:DataGrid ID="dgCase" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="Section ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridSectionID" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Section">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblGridSectionName" runat="server" CausesValidation="false" Width="100px"
                ...
                <asp:Panel ID="pnlDataDetail" runat="server">
                    <div id="divAddEdit" runat="server" style="width: 100%; text-align: left;">
                        <table style="width: 100%; text-align: left;">
                            <tr>
                                <th>
                                    <asp:Label ID="lblName" runat="server" Text="Section :" CssClass="CommonCaption"></asp:Label>
                                </th>
                                <th>
            ...
            <li>
                <div>
                    <asp:Button ID="btnAddSection" runat="server" Text="Add Section" Visible="true"
                        CausesValidation="true" OnClick="btnAddSection_Click" />
