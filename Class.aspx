<%@ Page Title="" Language="C#" MasterPageFile="~/SMSMainMaster.Master" AutoEventWireup="true" CodeBehind="Class.aspx.cs" Inherits="SMS.Class" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="frm1" runat="server">
        <ul>
            <li>
                <asp:Label ID="lblHeading" runat="server" Text="Class"
                    ...
                    <asp:DataGrid ID="dgCase" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="Class ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridClassID" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Class">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblGridClassName" runat="server" CausesValidation="false" Width="100px"
                ...
                <asp:Panel ID="pnlDataDetail" runat="server">
                    <div id="divAddEdit" runat="server" style="width: 100%; text-align: left;">
                        <table style="width: 100%; text-align: left;">
                            <tr>
                                <th>
                                    <asp:Label ID="lblName" runat="server" Text="Class :" CssClass="CommonCaption"></asp:Label>
                                </th>
                                <th>
            ...
            <li>
                <div>
                    <asp:Button ID="btnAddClass" runat="server" Text="Add Class" Visible="true"
                        CausesValidation="true" OnClick="btnAddClass_Click" />
