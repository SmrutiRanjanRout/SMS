<%@ Page Title="" Language="C#" MasterPageFile="~/SMSMainMaster.Master" AutoEventWireup="true" CodeBehind="TeachersCategory.aspx.cs" Inherits="SMS.TeachersCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="frm1" runat="server">
        <ul>
            <li>
                <asp:Label ID="lblHeading" runat="server" Text="TeachersCategory"
            ...
            <li>
                <div id="divView" runat="server" style="width: 100%; overflow: auto;">
                    <asp:DataGrid ID="dgCase" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="TeachersCategoryID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridTeachersCategoryID" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="TeachersCategory">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblGridTeachersCategoryName" runat="server" CausesValidation="false" Width="100px"
                ...
                <asp:Panel ID="pnlDataDetail" runat="server">
                    <div id="divAddEdit" runat="server" style="width: 100%; text-align: left;">
                        <table style="width: 100%; text-align: left;">
                            <tr>
                                <th>
                                    <asp:Label ID="lblName" runat="server" Text="TeachersCategory :" CssClass="CommonCaption"></asp:Label>
                                </th>
                                <th>
            ...
            <li>
                <div>
                    <asp:Button ID="btnAddTeachersCategory" runat="server" Text="Add Teachers" Visible="true"
                        CausesValidation="true" OnClick="btnAddTeachersCategory_Click" />
