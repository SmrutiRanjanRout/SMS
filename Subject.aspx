<%@ Page Title="" Language="C#" MasterPageFile="~/SMSMainMaster.Master" AutoEventWireup="true" CodeBehind="Subject.aspx.cs" Inherits="SMS.Subject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="frm1" runat="server">
        <ul>
            ...
            <li>
                <div id="divView" runat="server" style="width: 100%; overflow: auto;">
                    <asp:DataGrid ID="dgCase" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="Subject ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridSubjectID" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                ...
                <asp:Panel ID="pnlDataDetail" runat="server">
                    <div id="divAddEdit" runat="server" style="width: 100%; text-align: left;">
                        <table style="width: 100%; text-align: left;">
                            <tr>
                                <th>
                                    <asp:Label ID="lblName" runat="server" Text="Subject :" CssClass="CommonCaption"></asp:Label>
                                </th>
                                <th>
            ...
            <li>
                <div>
                    <asp:Button ID="btnAddSubject" runat="server" Text="Add Subject" Visible="true"
                        CausesValidation="true" OnClick="btnAddSubject_Click" />
