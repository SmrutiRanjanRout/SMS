...
namespace SMS
{
    public partial class Class : System.Web.UI.Page
    {
        ...
        protected void dgCase_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                if (e.Item.FindControl("lblGridClassID") != null)
                {
                    ClassID = ((Label)e.Item.FindControl("lblGridClassID")).Text;
                    this.ViewState["ClassID"] = ClassID;
                    PopulatePartDetail(ClassID);
        ...
        {
            {
                ...
                strSQL = "select Name, Cast(isActive as Int) as isActive from Class Where ID = " + Convert.ToString(this.ViewState["ClassID"]);
        ...
        private void PopulateClassData()
        {
            ...
            strSQL = "select id, Name, case isActive when 1 then 'Active' else 'InActive' end as IsActive from Class order by id";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (txtname.Text != "")
            {
                ...
                strSQL = "Insert into Class (Name, isActive)Values('" + txtname.Text.Trim() + "', " + Convert.ToInt32(rblActive.SelectedValue) + ")";
                ...
                {
                    this.lblMessage.Text = "Enter Class";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (txtname.Text != "")
            {
                ...
                ClassID = this.ViewState["ClassID"].ToString();

                string strSQL = string.Empty;

                int isActive = Convert.ToInt32(rblActive.SelectedValue);

                strSQL = "update Class set Name = '" + txtname.Text + "', isActive = " + isActive + " where id = " + ClassID;
            ...
            {
                this.lblMessage.Text = "Enter Class Name";
                this.lblMessage.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
            }
        }
