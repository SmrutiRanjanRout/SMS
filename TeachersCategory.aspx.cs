...
namespace SMS
{
    public partial class TeachersCategory : System.Web.UI.Page
    {
        ...
        protected void dgCase_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                if (e.Item.FindControl("lblGridTeachersCategoryID") != null)
                {
                    TeachersCategoryID = ((Label)e.Item.FindControl("lblGridTeachersCategoryID")).Text;
                    this.ViewState["TeachersCategoryID"] = TeachersCategoryID;
                    PopulatePartDetail(TeachersCategoryID);
                    this.btnAddTeachersCategory.Visible = false;
        ...
        {
            {
                ...
                strSQL = "select Name, Cast(isActive as Int) as isActive from TeachersCategory Where ID = " + Convert.ToString(this.ViewState["TeachersCategoryID"]);
        ...
        private void PopulateTeachersCategoryData()
        {
            string strSQL;
            DataTable objdt;
            clsDataAccess objAccess;
            ...
            objdt = new DataTable();
            objAccess = new clsDataAccess();
            strSQL = "select id, Name, case isActive when 1 then 'Active' else 'InActive' end as IsActive from TeachersCategory order by id";
        ...
        protected void btnAddTeachersCategory_Click(object sender, EventArgs e)
        {
            this.lblMessage.Text = "";
            PopulateClear();
            ...
            this.btnBack.Visible = true;
            this.btnCancel.Visible = false;
            this.ViewState["TeachersCategoryID"] = null;
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (txtname.Text != "")
            {
                ...
                string strSQL = string.Empty;
                clsDataAccess objAccess = new clsDataAccess();
                strSQL = "Insert into TeachersCategory (Name, isActive)Values('" + txtname.Text.Trim() + "', " + Convert.ToInt32(rblActive.SelectedValue) + ")";
                ...
                {
                    this.lblMessage.Text = "Enter TeachersCategory";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (txtname.Text != "")
            {
                int success = 0;
                string TeachersCategoryID = string.Empty;
                TeachersCategoryID = this.ViewState["TeachersCategoryID"].ToString();
                string strSQL = string.Empty;
                int isActive = Convert.ToInt32(rblActive.SelectedValue);
                strSQL = "update TeachersCategory set Name = '" + txtname.Text + "', isActive = " + isActive + " where id = " + TeachersCategoryID;
            ...
            {
                this.lblMessage.Text = "Enter TeachersCategory Name";
                this.lblMessage.ForeColor = System.Drawing.Color.FromArgb(255, 0, 0);
            }
        }
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            this.lblMessage.Text = "";
            this.btnAddTeachersCategory.Visible = true;
            this.btnSave.Visible = false;
            this.btnUpdate.Visible = false;
            this.btnEdit.Visible = false;
            this.btnBack.Visible = false;
