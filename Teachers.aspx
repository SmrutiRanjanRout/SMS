<%@ Page Title="" Language="C#" MasterPageFile="~/SMSMainMaster.Master" AutoEventWireup="true" CodeBehind="Teachers.aspx.cs" Inherits="SMS.Teachers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="frm1" runat="server">
        <ul>
            <li>
                <asp:Label ID="lblHeading" runat="server" Text="Teachers"
            ...
            <li>
                <div id="divView" runat="server" style="width: 100%; overflow: auto;">
                    <asp:DataGrid ID="dgCase" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="Teachers ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridTeachersID" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                             <asp:TemplateColumn HeaderText="Subject">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblGridSubject" runat="server" Text='<%# Bind("Subject") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Teachers Name">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblGridTeachersName" runat="server" CausesValidation="false" Width="100px"
...
                                </th> 
                             ...
                             <tr>
                                 <th>
                                     <asp:Label ID="lblSubject" runat="server" Text="Subject :" CssClass="CommonCaption"></asp:Label>
                                 </th>
                                 <th>
                            ...
                            <tr>
                                <th>
                                    <asp:Label ID="lblTeachersCategoryID" runat="server" Text="Class :" CssClass="CommonCaption"></asp:Label>
                                </th>
                                <th>
                                    <asp:DropDownList ID="ddlTeachersCategoryID" runat="server" AutoPostBack="true" 
                                        data-role="none" DataTextField="Name" DataValueField="ID"></asp:DropDownList>
                                </th>
                            </tr>
                            <tr>
            ...
            <li>
                <div>
                    <asp:Button ID="btnAddTeachers" runat="server" Text="Add Teachers" Visible="true"
                        CausesValidation="true" OnClick="btnAddTeachers_Click" />
